...
const aboutContent = readFileSync(
    join(SILVER_PAGES, '0eb2cc55-f281-56d3-9a61-bb680c902a6f'),
    'utf-8'
);
...
const linksContent = readFileSync(
    join(SILVER_PAGES, 'f35ac53d-96ec-5300-b58d-4a0f1cf68a1b'),
    'utf-8'
);
...
const friendSections = categories.map(cat => {
